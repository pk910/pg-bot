...
* [Pull Request] [fix(rpc): weight fee history rewards by receipt gas](https://github.com/paradigmxyz/reth/pull/26067) - 2026-07-02
* [Pull Request] [fix(rpc): estimate eip-2780 basic transfers](https://github.com/paradigmxyz/reth/pull/26068) - 2026-07-02
* [Review] [Review on: feat(net): add default-off snap/2 negotiation](https://github.com/paradigmxyz/reth/pull/25774#pullrequestreview-4615663856) - 2026-07-02
...
* [Review] [Review on: refactor(trie): remove ParallelStateRoot](https://github.com/paradigmxyz/reth/pull/26121#pullrequestreview-4625674956) - 2026-07-03
...
* [Pull Request] [perf(txpool): dedupe getBlobs fallback reads](https://github.com/paradigmxyz/reth/pull/26255) - 2026-07-06
...
* [Pull Request] [fix(txpool): record a parked ancestor, not a low fee cap, on dragged dependents](https://github.com/paradigmxyz/reth/pull/26974) - 2026-09-03
...
* [Pull Request] [perf(discv4): reject duplicate and unknown packets before recovering the key](https://github.com/paradigmxyz/reth/pull/26935) - 2026-09-02
* [Pull Request] [refactor(net): rewrite transaction fetcher](https://github.com/paradigmxyz/reth/pull/26924) - 2026-09-02
* [Review] [Review on: refactor(net): rewrite transaction fetcher](https://github.com/paradigmxyz/reth/pull/26924#pullrequestreview-5094332602) - 2026-09-02
* [Pull Request] [perf(net): trim per hash work when handling announcements](https://github.com/paradigmxyz/reth/pull/26931) - 2026-09-02
* [Pull Request] [perf(net): defer decoding of snap responses until correlated with a request](https://github.com/paradigmxyz/reth/pull/26928) - 2026-09-02
* [Pull Request] [perf(net): defer decoding of eth responses until correlated with a request](https://github.com/paradigmxyz/reth/pull/26926) - 2026-09-02
* [Review] [Review on: perf(net): defer decoding of eth responses until correlated with a request](https://github.com/paradigmxyz/reth/pull/26926#pullrequestreview-5092115265) - 2026-09-02
* [Pull Request] [perf(nippy-jar): only commit a jar when the consistency checker healed it](https://github.com/paradigmxyz/reth/pull/26930) - 2026-09-02
* [Pull Request] [perf(storage): skip committing static file segments that did not change](https://github.com/paradigmxyz/reth/pull/26932) - 2026-09-02
* [Pull Request] [perf: cut node startup latency from ~1.5s to ~0.3s](https://github.com/paradigmxyz/reth/pull/26927) - 2026-09-02
* [Pull Request] [perf(discv5): don't block startup on boot node ENR requests](https://github.com/paradigmxyz/reth/pull/26929) - 2026-09-02
* [Review] [Review on: refactor(provider): remove historical state conversion](https://github.com/paradigmxyz/reth/pull/26904#pullrequestreview-5090593771) - 2026-09-02
...
* [Review] [Review on: fix(cli): use configured minimal download defaults](https://github.com/paradigmxyz/reth/pull/26934#pullrequestreview-5112494518) - 2026-09-04
* [Review] [Review on: refactor(overlay): reduce execution overlay setup overhead](https://github.com/paradigmxyz/reth/pull/26990#pullrequestreview-5112188243) - 2026-09-04
...
* [Pull Request] [chore(engine): trace parent-state cache miss reads](https://github.com/paradigmxyz/reth/pull/27085) - 2026-09-08
...
* [Pull Request] [chore(rpc): increase default transaction hash cache to 100k](https://github.com/paradigmxyz/reth/pull/27137) - 2026-09-10
...
* [Pull Request] [chore: bump revm and reth-core deps](https://github.com/paradigmxyz/reth/pull/27401) - 2026-09-24
...
* [Review] [Review on: fix(cli): open stage dump environment read-write](https://github.com/paradigmxyz/reth/pull/23602#pullrequestreview-4127094926) - 2026-04-17
...
* [Pull Request] [feat(net): enable ETH70 by default](https://github.com/paradigmxyz/reth/pull/23771) - 2026-04-28
* [Pull Request] [feat(engine): add getBlobsV4 endpoint](https://github.com/paradigmxyz/reth/pull/23767) - 2026-04-28
* [Review] [Review on: feat(engine): disable BAL storage prefetch on CLI arg](https://github.com/paradigmxyz/reth/pull/23770#pullrequestreview-4188327709) - 2026-04-28
...
* [Review] [Review on: feat(node, db-common): add --debug.skip-genesis-validation](https://github.com/paradigmxyz/reth/pull/23919#pullrequestreview-4218709189) - 2026-05-04
...
* [Review] [Review on: chore(BAL): dedup spawn_receipt_root_task](https://github.com/paradigmxyz/reth/pull/24004#pullrequestreview-4233772537) - 2026-05-06
...
* [Review] [Review on: docs(rpc): mark admin_peerEvents as unimplemented](https://github.com/paradigmxyz/reth/pull/24014#pullrequestreview-4241584868) - 2026-05-07
...
* [Pull Request] [fix(rpc): reuse cached block access lists](https://github.com/paradigmxyz/reth/pull/24185) - 2026-05-13
* [Pull Request] [refactor(storage): remove BAL range lookup](https://github.com/paradigmxyz/reth/pull/24180) - 2026-05-13
* [Review] [Review on: feat: retain announced port](https://github.com/paradigmxyz/reth/pull/24182#pullrequestreview-4280790142) - 2026-05-13
* [Review] [Review on: perf: preallocate receipt root encode buffer](https://github.com/paradigmxyz/reth/pull/24173#pullrequestreview-4278979583) - 2026-05-13
...
* [Pull Request] [fix(cli): reject zero db list len](https://github.com/paradigmxyz/reth/pull/24283) - 2026-05-18
* [Review] [Review on: chore(bench): remove reth-bench](https://github.com/paradigmxyz/reth/pull/24288#pullrequestreview-4309695767) - 2026-05-18
* [Pull Request] [refactor(tx-pool): simplify blob cell lookup](https://github.com/paradigmxyz/reth/pull/24290) - 2026-05-18
* [Pull Request] [fix(rpc): remove stale debug endpoints](https://github.com/paradigmxyz/reth/pull/24284) - 2026-05-18
...
* [Review] [Review on: chore(deps): bump the cargo-weekly group across 1 directory with 14 updates](https://github.com/paradigmxyz/reth/pull/24291#pullrequestreview-4316419562) - 2026-05-19
* [Review] [Review on: perf(engine): avoid tiny multiproof chunks](https://github.com/paradigmxyz/reth/pull/24236#pullrequestreview-4316393612) - 2026-05-19
...
* [Pull Request] [perf(txpool): add best transaction size hints](https://github.com/paradigmxyz/reth/pull/24417) - 2026-05-22
...
* [Review] [Review on: fix(rpc): collect eth_simulate transfer logs separately](https://github.com/paradigmxyz/reth/pull/24729#pullrequestreview-4407751345) - 2026-06-02
* [Review] [Review on: fix(rpc): avoid warming moved precompiles](https://github.com/paradigmxyz/reth/pull/24755#pullrequestreview-4407652723) - 2026-06-02
...
* [Pull Request] [feat(rpc): allow disabling rpc metrics](https://github.com/paradigmxyz/reth/pull/24803) - 2026-06-03
* [Review] [Review on: fix(docs): simplify homepage hero layout](https://github.com/paradigmxyz/reth/pull/24805#pullrequestreview-4417635263) - 2026-06-03
* [Review] [Review on: fix(docs): load homepage styles in Vocs v2](https://github.com/paradigmxyz/reth/pull/24804#pullrequestreview-4417369733) - 2026-06-03
...
* [Review] [Review on: chore(era): remove per-reader `FileReader` impls](https://github.com/paradigmxyz/reth/pull/24854#pullrequestreview-4427323654) - 2026-06-04
* [Review] [Review on: chore(docs): upgrade Vocs to v2](https://github.com/paradigmxyz/reth/pull/24849#pullrequestreview-4426961254) - 2026-06-04
* [Review] [Review on: fix(engine): update ssz proxy endpoint paths](https://github.com/paradigmxyz/reth/pull/24844#pullrequestreview-4425773073) - 2026-06-04
...
* [Review] [Review on: feat(revm): introduce `DatabaseStateProvider`](https://github.com/paradigmxyz/reth/pull/25121#pullrequestreview-4475608487) - 2026-06-11
* [Pull Request] [chore(deps): patch alloy crates to main](https://github.com/paradigmxyz/reth/pull/25123) - 2026-06-11
* [Review] [Review on: feat(rpc): add testing commit block endpoint](https://github.com/paradigmxyz/reth/pull/25070#pullrequestreview-4475471969) - 2026-06-11
...
* [Pull Request] [refactor(rpc): store decoded revm BALs behind Arc](https://github.com/paradigmxyz/reth/pull/25165) - 2026-06-12
* [Review] [Review on: feat(rpc): validate BAL in builder submission v6](https://github.com/paradigmxyz/reth/pull/24297#pullrequestreview-4484793180) - 2026-06-12
* [Pull Request] [refactor(net): reuse primitive sealed block wrapper](https://github.com/paradigmxyz/reth/pull/25162) - 2026-06-12
...
* [Review] [Review on: fix(rpc): buffer trace_filter block replays](https://github.com/paradigmxyz/reth/pull/25133#pullrequestreview-4490645879) - 2026-06-13
...
* [Review] [Review on: docs: reference EIPs for recent eth versions](https://github.com/paradigmxyz/reth/pull/25317#pullrequestreview-4505467514) - 2026-06-16
...
* [Pull Request] [chore(deps): update alloy-eip7928 to 0.4.4](https://github.com/paradigmxyz/reth/pull/25368) - 2026-06-17
...
* [Review] [Review on: fix(trie): return empty proof for empty storage and account tries in eth_getProof](https://github.com/paradigmxyz/reth/pull/24719#pullrequestreview-4543328175) - 2026-06-22
...
* [Review] [Review on: fix(rpc): zero parentBeaconBlockRoot in eth_simulateV1](https://github.com/paradigmxyz/reth/pull/22951#pullrequestreview-3931878866) - 2026-03-11
