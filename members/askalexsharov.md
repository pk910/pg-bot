...
* [Review] [Review on: execution: mid-block resume follow-ups — prior receipts, notifications, blooms, blob gas](https://github.com/erigontech/erigon/pull/22235#pullrequestreview-4630629688) - 2026-07-05
...
* [Commit] [rpc/mcp, node/eth: shut down MCP SSE server on ctx cancel (#22230)](https://github.com/erigontech/erigon/commit/01c35b2953c855b1a55fa18ce80de05246db3af3) - 2026-07-06
...
* [Pull Request] [[wip] `--persist.receipts.distance` to skip download](https://github.com/erigontech/erigon/pull/22349) - 2026-07-09
...
* [Review] [Review on: `--persist.receipts.distance` support](https://github.com/erigontech/erigon/pull/22349#pullrequestreview-4668116342) - 2026-07-10
...
* [Commit] [db/snapshotsync: embed View.segments as fixed-size array to cut BeginRo allocs (#22341)](https://github.com/erigontech/erigon/commit/0d4253b355e5c6023f1ea0a8429959397c2ee7c9) - 2026-07-11
...
* [Review] [Review on: block files: enable long-living view in block_reader by default](https://github.com/erigontech/erigon/pull/22445#pullrequestreview-4691076981) - 2026-07-14
...
* [Review] [Review on: hive-test: add skill frontmatter](https://github.com/erigontech/erigon/pull/22506#pullrequestreview-4710495205) - 2026-07-16
...
* [Pull Request] [[wip] execution: store EVM logs by value in IntraBlockState](https://github.com/erigontech/erigon/pull/22723) - 2026-07-25
...
* [Pull Request] [vm: non-ptr `accessOptions` ](https://github.com/erigontech/erigon/pull/22721) - 2026-07-25
* [Review] [Review on: vm: non-ptr `accessOptions` ](https://github.com/erigontech/erigon/pull/22721#pullrequestreview-4777945637) - 2026-07-25
* [Pull Request] [[wip] execution/vm/benchmark: bench EVM through the parallel-exec versioned-map path](https://github.com/erigontech/erigon/pull/22724) - 2026-07-25
...
* [Pull Request] [[r3.6] execution/stagedsync: walk the per-path maps in normalizeWriteSet](https://github.com/erigontech/erigon/pull/23049) - 2026-08-06
...
* [Commit] [cmd/rpctest: split wide eth_getLogs filters in invariantsEthGetLogs (#23211)](https://github.com/erigontech/erigon/commit/61774d9e9fd648a2f0fde48485aa1f32add6fffc) - 2026-08-13
...
* [Review] [Review on: execution/stagedsync: compute a tx's fee credit once, not on every revalidation](https://github.com/erigontech/erigon/pull/23132#pullrequestreview-4932932734) - 2026-08-14
...
* [Commit] [p2p/protocols/eth, execution/rlp: measure EncodeRLP itself, skip alloc assertions under -race (#23262)](https://github.com/erigontech/erigon/commit/40f60990d078ce1dcdf7102390e24a99a4288d62) - 2026-08-17
...
* [Pull Request] [db/etl: hold the entry index inside each chunk, so Put never re-allocates](https://github.com/erigontech/erigon/pull/23599) - 2026-08-26
* [Review] [Review on: db/etl: hold the entry index inside each chunk, so Put never re-allocates](https://github.com/erigontech/erigon/pull/23599#pullrequestreview-5036829379) - 2026-08-27
...
* [Pull Request] [db/etl: give the provider merge the tricks the chunk merge uses](https://github.com/erigontech/erigon/pull/23616) - 2026-08-27
* [Review] [Review on: execution/cache: track GenericCache entry count in an atomic, not freelru's all-shard Len](https://github.com/erigontech/erigon/pull/23522#pullrequestreview-5027035699) - 2026-08-26
...
* [Review] [Review on: db/integrity: make CommitmentKvDeref report the keys it scanned](https://github.com/erigontech/erigon/pull/23597#pullrequestreview-5030034316) - 2026-08-26
...
* [Pull Request] [db/etl: read a buffer with Next instead of Get(i)](https://github.com/erigontech/erigon/pull/23621) - 2026-08-27
...
* [Review] [Review on: db/state: derive domain_prunable from the values table's prune progress, not the history keys table](https://github.com/erigontech/erigon/pull/23622#pullrequestreview-5038934860) - 2026-08-27
* [Review] [Review on: lru: accounting per-key overhead](https://github.com/erigontech/erigon/pull/23552#pullrequestreview-5038372266) - 2026-08-27
...
* [Commit] [execution/stagedsync: COMMITMENT_AFTER_EXEC flag to serialize commitment behind execution (#23515)](https://github.com/erigontech/erigon/commit/44ecb79286768c8f16a08fd8473aba5ef6f4b24a) - 2026-08-27
...
* [Review] [Review on: execution/state: skip the self-destruct storage walk when the address has no account](https://github.com/erigontech/erigon/pull/23604#pullrequestreview-5047938491) - 2026-08-28
...
* [Pull Request] [exec, commitment, cl/beacon: clear pooled objects (which hold bytecode ptr)](https://github.com/erigontech/erigon/pull/23642) - 2026-08-28
...
* [Review] [Review on: execution/commitment: let trie warmup borrow branch bytes instead of copying them](https://github.com/erigontech/erigon/pull/23585#pullrequestreview-5050335721) - 2026-08-28
...
* [Pull Request] [rpc: encode the RPC result into the stream instead of a fresh buffer](https://github.com/erigontech/erigon/pull/23753) - 2026-09-02
...
* [Pull Request] [rpc/jsonstream: write a large raw payload straight to the writer](https://github.com/erigontech/erigon/pull/23739) - 2026-09-02
* [Review] [Review on: [DO-NOT-MERGE] execution/vm: return state-gas to gas_left when a child merges](https://github.com/erigontech/erigon/pull/23718#pullrequestreview-5087985262) - 2026-09-02
* [Pull Request] [execution/types: add Bloom.AppendText](https://github.com/erigontech/erigon/pull/23736) - 2026-09-02
* [Pull Request] [execution/tracing/tracers/native: stream callFrame under encoding/json v2](https://github.com/erigontech/erigon/pull/23744) - 2026-09-02
* [Pull Request] [all: upgrade minimum Go version to 1.26](https://github.com/erigontech/erigon/pull/23735) - 2026-09-02
* [Pull Request] [db/downloader: report kept-local seeding dropped by shutdown](https://github.com/erigontech/erigon/pull/23745) - 2026-09-02
* [Pull Request] [chaindata: disable readahead by default](https://github.com/erigontech/erigon/pull/23723) - 2026-09-02
* [Pull Request] [execution/types: fast-path JSON for the eth_getLogs result](https://github.com/erigontech/erigon/pull/23740) - 2026-09-02
...
* [Pull Request] [db: remove variable shadowing](https://github.com/erigontech/erigon/pull/23779) - 2026-09-03
...
* [Review] [Review on: execution/vm: evmone_precompiles v0.23.0](https://github.com/erigontech/erigon/pull/23231#pullrequestreview-5097055084) - 2026-09-03
...
* [Review] [Review on: execution/commitment: let trie warmup borrow branch bytes instead of copying them](https://github.com/erigontech/erigon/pull/23585#pullrequestreview-5097049090) - 2026-09-03
...
* [Pull Request] [db/state: decode contract code through a pooled buffer and hand back the cached copy](https://github.com/erigontech/erigon/pull/23798) - 2026-09-04
...
* [Pull Request] [lint: enable `shadow` linter for `./db` pkgs (step 2)](https://github.com/erigontech/erigon/pull/23785) - 2026-09-04
* [Review] [Review on: lint: enable `shadow` linter for `./db` pkgs (step 1)](https://github.com/erigontech/erigon/pull/23779#pullrequestreview-5109036873) - 2026-09-04
...
* [Commit] [db/seg: drop dead code, fix the ParseFileCompression stub (#23788)](https://github.com/erigontech/erigon/commit/3f065c5a6865a5b4b31eb8e2761abbb6155b1012) - 2026-09-05
...
* [Review] [Review on: build: give C++ deps the same cgo flags as C](https://github.com/erigontech/erigon/pull/23874#pullrequestreview-5148901347) - 2026-09-09
* [Review] [Review on: build(deps): bump colord from 2.9.3 to 2.10.0 in /docs/site](https://github.com/erigontech/erigon/pull/23876#pullrequestreview-5150344840) - 2026-09-09
* [Review] [Review on: QA: update execution apis ref 6570b55](https://github.com/erigontech/erigon/pull/23873#pullrequestreview-5150114498) - 2026-09-09
...
* [Commit] [cl/services: ignore, and retry, a block the execution layer did not answer for (#23836)](https://github.com/erigontech/erigon/commit/edd44e176bc195c98d1fd2183ee7f6cb5303444b) - 2026-09-09
* [Commit] [cl/services: claim the attestation seen slot only after signature verification (#23832)](https://github.com/erigontech/erigon/commit/d94e08031c3e3c1e51cdef213dd4f5d37f2e976e) - 2026-09-09
...
* [Pull Request] [rpc: bound block and BAL caches by bytes and remove mutex-contention](https://github.com/erigontech/erigon/pull/23997) - 2026-09-15
...
* [Review] [Review on: execution/commitment: remove unreachable serial trunk preload](https://github.com/erigontech/erigon/pull/23973#pullrequestreview-5197965386) - 2026-09-14
* [Pull Request] [.github: build release docker images with golang:1.27-bookworm](https://github.com/erigontech/erigon/pull/23961) - 2026-09-14
* [Review] [Review on: .github: build release docker images with golang:1.27-bookworm](https://github.com/erigontech/erigon/pull/23961#pullrequestreview-5197036676) - 2026-09-14
...
* [Pull Request] [rpc/jsonrpc: add eth_getProof and eth_getWitness test coverage](https://github.com/erigontech/erigon/pull/24040) - 2026-09-16
...
* [Pull Request] [db: auto-compact bloated mdbx dbs at startup](https://github.com/erigontech/erigon/pull/23956) - 2026-09-15
...
* [Review] [Review on: execution/commitment: encode the trie state without `encoding/binary` reflection](https://github.com/erigontech/erigon/pull/24009#pullrequestreview-5206477708) - 2026-09-15
* [Pull Request] [rpc/jsonrpc: serve the cached chain config without opening a read transaction](https://github.com/erigontech/erigon/pull/24002) - 2026-09-15
* [Review] [Review on: rpc/jsonrpc: serve the cached chain config without opening a read transaction](https://github.com/erigontech/erigon/pull/24002#pullrequestreview-5205919494) - 2026-09-15
...
* [Commit] [build, ci: require x86-64-v2 on amd64, drop the separate amd64v2 artifact (#23877)](https://github.com/erigontech/erigon/commit/d29afb285895b972c3e60d344789bb1f24370fd8) - 2026-09-15
* [Commit] [.github: build release docker images with golang:1.27-bookworm (#23961)](https://github.com/erigontech/erigon/commit/86798703f13f547de5ab41ca6fbf285df815285c) - 2026-09-15
...
* [Pull Request] [rpc/gasprice: resolve warm `eth_feeHistory` cache keys from cached parents](https://github.com/erigontech/erigon/pull/24063) - 2026-09-16
* [Pull Request] [execution/types/accounts: encode eth_getProof results without reflection](https://github.com/erigontech/erigon/pull/24062) - 2026-09-16
* [Review] [Review on: execution/types/accounts: encode eth_getProof results without reflection](https://github.com/erigontech/erigon/pull/24062#pullrequestreview-5222576363) - 2026-09-16
* [Pull Request] [rpc: run a single HTTP call on the connection goroutine](https://github.com/erigontech/erigon/pull/24060) - 2026-09-16
* [Review] [Review on: rpc: run a single HTTP call on the connection goroutine](https://github.com/erigontech/erigon/pull/24060#pullrequestreview-5222576080) - 2026-09-16
* [Review] [Review on: execution/state: validate empty code-hash reads against account liveness](https://github.com/erigontech/erigon/pull/24030#pullrequestreview-5219687626) - 2026-09-16
* [Pull Request] [up x deps for release/3.7](https://github.com/erigontech/erigon/pull/24054) - 2026-09-16
* [Review] [Review on: up x deps for release/3.7](https://github.com/erigontech/erigon/pull/24054#pullrequestreview-5221431247) - 2026-09-16
* [Review] [Review on: db/kv/mdbx: `tx_renew` instead `tx_begin` for ro-txs](https://github.com/erigontech/erigon/pull/24014#pullrequestreview-5219431709) - 2026-09-16
* [Review] [Review on: execution, rpc: decode block access list addresses without interning](https://github.com/erigontech/erigon/pull/24024#pullrequestreview-5218085594) - 2026-09-16
...
* [Commit] [db/state: lazy-ETL collectors (#24079)](https://github.com/erigontech/erigon/commit/d51bc0fe6c38d7523b1943293e5d6f2f0bd9edff) - 2026-09-18
...
* [Pull Request] [paged writer: lost amount of workers](https://github.com/erigontech/erigon/pull/20335) - 2026-04-05
* [Review] [Review on: Ban peer on misbehaviour](https://github.com/erigontech/erigon/pull/20336#pullrequestreview-4059298781) - 2026-04-05
* [Pull Request] [migrate to bubbles v2](https://github.com/erigontech/erigon/pull/20338) - 2026-04-05
* [Pull Request] [db: unused code remove](https://github.com/erigontech/erigon/pull/20334) - 2026-04-05
* [Pull Request] [cmd/rpctest: helpers for open files and fetching blocks](https://github.com/erigontech/erigon/pull/20339) - 2026-04-05
* [Pull Request] [logs: move some Info logs to Debug level (to simplify logs for Users)](https://github.com/erigontech/erigon/pull/20329) - 2026-04-05
* [Review] [Review on: Bug 1: Fix integrity check at domain <-> history boundary (cherry-pick to 3.4)](https://github.com/erigontech/erigon/pull/20313#pullrequestreview-4059300577) - 2026-04-05
...
* [Pull Request] [xsync deprecated use fix](https://github.com/erigontech/erigon/pull/20331) - 2026-04-05
...
* [Review] [Review on: [SharovBot] fix: preserve stored chain config when genesis hash doesn't match known chain](https://github.com/erigontech/erigon/pull/20367#pullrequestreview-4065788219) - 2026-04-07
...
* [Pull Request] [drop `diag/ui`](https://github.com/erigontech/erigon/pull/20404) - 2026-04-08
* [Review] [Review on: cl/caplin: fix blob and data column pruning (never ran, wrong range, configurable keep window)](https://github.com/erigontech/erigon/pull/20379#pullrequestreview-4073656108) - 2026-04-08
* [Review] [Review on: execution/execmodule: test EIP-7708 burn log when coinbase self-destructs](https://github.com/erigontech/erigon/pull/20416#pullrequestreview-4074746733) - 2026-04-08
...
* [Pull Request] [cp: cherry-pick batch 2 from release/3.4 to main](https://github.com/erigontech/erigon/pull/20405) - 2026-04-10
* [Review] [Review on: build(deps): bump geekyeggo/delete-artifact from 5 to 6](https://github.com/erigontech/erigon/pull/20348#pullrequestreview-4086877762) - 2026-04-10
...
* [Pull Request] [[wip] RoSnapshots: lock-free .View method](https://github.com/erigontech/erigon/pull/20490) - 2026-04-11
...
* [Pull Request] [[r3.4] db/state: fix collation/pruning race and unwind visibility in BuildFilesInBackground](https://github.com/erigontech/erigon/pull/20594) - 2026-04-16
...
* [Pull Request] [ci: pin glamsterdam ethereum-package to 6.1.0 ](https://github.com/erigontech/erigon/pull/20593) - 2026-04-16
...
* [Review] [Review on: execution: share prune timeout budget](https://github.com/erigontech/erigon/pull/20860#pullrequestreview-4186817857) - 2026-04-28
...
* [Review] [Review on: rpc: fix prestateTracer diff mode missing deleted accounts](https://github.com/erigontech/erigon/pull/20807#pullrequestreview-4193700582) - 2026-04-29
...
* [Review] [Review on: wire --erigondb.domain.steps-in-frozen-file for stage_exec and seg retire](https://github.com/erigontech/erigon/pull/21025#pullrequestreview-4241944095) - 2026-05-07
* [Review] [Review on: db/state, db/integrity: FilesOnlyStateReader for commitment rebuild and CommitmentRoot](https://github.com/erigontech/erigon/pull/21026#pullrequestreview-4241948458) - 2026-05-07
...
* [Review] [Review on: execution/commitment: enchance MPT hashing hot-paths to reduce allocations](https://github.com/erigontech/erigon/pull/20796#pullrequestreview-4269706751) - 2026-05-12
...
* [Review] [Review on: docs/site: fix Dependabot npm alerts via overrides](https://github.com/erigontech/erigon/pull/21168#pullrequestreview-4281287458) - 2026-05-13
* [Review] [Review on: db/recsplit: set ExistenceFilterVersion to 1](https://github.com/erigontech/erigon/pull/21164#pullrequestreview-4279711430) - 2026-05-13
* [Review] [Review on: commitment/nibbles: add V2 key encoder/decoder](https://github.com/erigontech/erigon/pull/21146#pullrequestreview-4277915620) - 2026-05-13
* [Review] [Review on: db/kv, db/kv/prune: range-del fast paths in TableScanningPrune](https://github.com/erigontech/erigon/pull/21166#pullrequestreview-4280098682) - 2026-05-13
* [Review] [Review on: [r3.4] wire `--erigondb.domain.steps-in-frozen-file` for `stage_exec` and `seg retire`](https://github.com/erigontech/erigon/pull/21149#pullrequestreview-4277909954) - 2026-05-13
* [Review] [Review on: execution, rlp: switch total difficulty and chainID to uint256.Int](https://github.com/erigontech/erigon/pull/21119#pullrequestreview-4277896441) - 2026-05-13
...
* [Pull Request] [deps: golangci-lint v2.11.4→v2.12.2, golang.org/x/ ](https://github.com/erigontech/erigon/pull/21182) - 2026-05-14
...
* [Commit] [[main] db: commitment domain to take existance filter to RAM (#21738)](https://github.com/erigontech/erigon/commit/1b5e752b415d22fc2396aee53353351b94ce6148) - 2026-06-11
...
* [Pull Request] [db/recsplit: enable sharded FuseFilter by default](https://github.com/erigontech/erigon/pull/21797) - 2026-06-14
...
* [Pull Request] [[wip] db/state: store large/commitment domain values in seqID-indexed table](https://github.com/erigontech/erigon/pull/21801) - 2026-06-14
...
* [Commit] [db/state: bound commitmentValTransformDomain key caches (#21929)](https://github.com/erigontech/erigon/commit/cfc031d232ea909a40f8f420feba292ac36e1c5b) - 2026-06-23
...
* [Pull Request] [common/dbg, db, execution, txpool: migrate assert.Enable to dbg.AssertEnabled](https://github.com/erigontech/erigon/pull/22108) - 2026-06-30
...
* [Review] [Review on: parallel: reduce execRequests/in/applyResults buffers from 100k to prevent OOM](https://github.com/erigontech/erigon/pull/19818#pullrequestreview-3933974791) - 2026-03-12
* [Review] [Review on: ci: use golang:1.26-trixie for snapshot docker images](https://github.com/erigontech/erigon/pull/19823#pullrequestreview-3933972191) - 2026-03-12
...
* [Pull Request] [[wip] evm: accesList.Reset()](https://github.com/erigontech/erigon/pull/19983) - 2026-03-18
...
* [Pull Request] [collate: sequence builder re-use](https://github.com/erigontech/erigon/pull/19992) - 2026-03-19
...
* [Review] [Review on: [r3.4] chainspec, cl/clparams: schedule Gnosis Fusaka + Osaka](https://github.com/erigontech/erigon/pull/20091#pullrequestreview-3990763551) - 2026-03-23
